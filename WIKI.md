...
数量界面没有上一页 / 下一页。第一行正中是返回，右上角关闭；第二行七个发光绿羊毛 **×1 / ×2 / ×4 / ×8 / ×16 / ×32 / ×64**（数字写在物品名上）；中间预览商品，再下一行点纸确认。
...
| 商店数量选择界面          | `plugins/UltimateShop/menus/buy-more-buy.yml`、`buy-more-sell.yml`、`buy-more.yml`（第一行正中返回、右上关闭；第二行 ×1–×64；无翻页） |
