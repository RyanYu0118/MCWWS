...
| 客户端生存配套模组 | **1.4.6+**（文件名 `MCWWS_AxiomSurvivalClient-1.4.6-needMCWWS_AxiomSurvival+1.1.9.jar`；可与服务端 1.1.11 搭配） |
...
| MCWWS_AxiomSurvivalClient | 1.4.6 | Axiom 生存客户端，装进游戏 `mods/`；jar 含 `needMCWWS_AxiomSurvival+1.1.9` |
