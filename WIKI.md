...
| 客户端生存配套模组 | **1.4.4+**（文件名 `MCWWS_AxiomSurvivalClient-1.4.4-needMCWWS_AxiomSurvival+1.1.9.jar`） |
...
| MCWWS_AxiomSurvival | 1.1.9 | 生存 Axiom 扣费、容器内容物价、实体操作计价、禁止切创造；适配 AxiomPaper 6 隧道包；需客户端 1.4.4 |
| MCWWS_AxiomSurvivalClient | 1.4.4 | Axiom 生存客户端，装进游戏 `mods/`；jar 含 `needMCWWS_AxiomSurvival+1.1.9` |
