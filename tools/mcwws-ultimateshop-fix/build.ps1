...
$McwwsJar = Get-McwwsPluginJarPaths -RepoRoot $Root -PluginName "MCWWS_UltimateShopFix" -ResourcesDir $Res
...
$CpParts = @($PaperApi, $UltimateShop) + $Libs | Where-Object { $_ -and (Test-Path $_) }
...
Publish-McwwsPluginJar -JarExe $JarExe -ClassesDir $Out -JarPaths $McwwsJar -PluginName "MCWWS_UltimateShopFix"
