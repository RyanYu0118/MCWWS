...
public class CreativeModeInventoryScreen extends AbstractContainerScreen<net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.ItemPickerMenu> {
   ...
   public CreativeModeInventoryScreen(final LocalPlayer player, final FeatureFlagSet enabledFeatures, final boolean displayOperatorCreativeTab) {
      super(
         new net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.ItemPickerMenu(player),
         player.getInventory(),
               ...
               if (slot == this.destroyItemSlot) {
                  ...
                  this.minecraft
                     ...
                     .handleCreativeModeItemAdd(
                        afterDrop, ((net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.SlotWrapper)slot).target.index
                     );
                  ...
                  this.minecraft
                     ...
                     .inventoryMenu
                     .clicked(
                        slot == null ? slotId : ((net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.SlotWrapper)slot).target.index,
                        buttonNum,
                        containerInput,
   ...
   private void selectTab(final CreativeModeTab tab) {
      ...
      if (selectedTab.getType() == Type.INVENTORY) {
         ...
         for (int ix = 0; ix < invMenu.slots.size(); ix++) {
            ...
            Slot slot = new net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.SlotWrapper(invMenu.slots.get(ix), ix, x, y);
   ...
   public List<Component> getTooltipFromContainerItem(final ItemStack itemStack) {
      boolean isCreativeSlot = this.hoveredSlot != null
         && this.hoveredSlot instanceof net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.CustomCreativeSlot;
   ...
   public static class ItemPickerMenu extends AbstractContainerMenu {
      ...
      public ItemPickerMenu(final Player player) {
         ...
         for (int y = 0; y < 5; y++) {
            for (int x = 0; x < 9; x++) {
               this.addSlot(
                  new net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.CustomCreativeSlot(
                     net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.CONTAINER, y * 9 + x, 9 + x * 18, 18 + y * 18
                  )
               );
            }
         }
         ...
         for (int y = 0; y < 5; y++) {
            for (int x = 0; x < 9; x++) {
               ...
               if (slot >= 0 && slot < this.items.size()) {
                  net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.CONTAINER.setItem(x + y * 9, this.items.get(slot));
               } else {
                  net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.CONTAINER.setItem(x + y * 9, ItemStack.EMPTY);
               }
            }
         }
      }
      ...
      public boolean canTakeItemForPickAll(final ItemStack carried, final Slot target) {
         return target.container != net.minecraft.client.gui.screens.inventory.CreativeModeInventoryScreen.CONTAINER;
      }
