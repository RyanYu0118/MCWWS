...
@RelatedProperty(value="display name")
public class PropExprCustomName
extends PropertyBaseExpression<ExpressionPropertyHandler<?, ?>> {
    public static void register(SyntaxRegistry registry) {
        registry.register(SyntaxRegistry.EXPRESSION, ((DefaultSyntaxInfos.Expression.Builder)PropertyExpression.infoBuilder(PropExprCustomName.class, Object.class, "(display|nick|chat|custom)[ ]name[s]", "objects", false).supplier(PropExprCustomName::new)).build());
    }
