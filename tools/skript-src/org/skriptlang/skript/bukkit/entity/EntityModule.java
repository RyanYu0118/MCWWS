 ...
 *  org.bukkit.entity.AbstractNautilus
 */
...
extends HierarchicalAddonModule {
    ...
    public Iterable<AddonModule> children() {
        return List.of(new DisplayModule(this), new InteractionModule(this), new PlayerModule(this));
    }
    ...
    protected void loadSelf(SkriptAddon addon) {
        ...
        this.register(addon, ExprDeathMessage::register);
    }
