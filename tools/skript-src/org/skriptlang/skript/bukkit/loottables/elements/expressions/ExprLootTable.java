...
extends SimplePropertyExpression<Object, LootTable> {
    public static void register(SyntaxRegistry registry) {
        registry.register(SyntaxRegistry.EXPRESSION, ((DefaultSyntaxInfos.Expression.Builder)ExprLootTable.infoBuilder(ExprLootTable.class, LootTable.class, "loot[ ]table[s]", "entities/blocks", false).supplier(ExprLootTable::new)).build());
    }
