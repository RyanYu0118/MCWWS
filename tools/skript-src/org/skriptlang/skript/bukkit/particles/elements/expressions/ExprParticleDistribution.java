...
extends SimplePropertyExpression<ParticleEffect, Vector> {
    public static void register(SyntaxRegistry registry) {
        registry.register(SyntaxRegistry.EXPRESSION, ((DefaultSyntaxInfos.Expression.Builder)ExprParticleDistribution.infoBuilder(ExprParticleDistribution.class, Vector.class, "particle distribution", "particles", false).supplier(ExprParticleDistribution::new)).build());
    }
