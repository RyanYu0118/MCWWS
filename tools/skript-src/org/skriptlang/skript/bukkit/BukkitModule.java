...
import org.skriptlang.skript.bukkit.types.ItemTypeClassInfo;
import org.skriptlang.skript.bukkit.types.LocationClassInfo;
import org.skriptlang.skript.bukkit.types.NameableClassInfo;
...
import org.skriptlang.skript.bukkit.types.SlotClassInfo;
import org.skriptlang.skript.bukkit.types.VectorClassInfo;
...
extends HierarchicalAddonModule {
    ...
    public Iterable<AddonModule> children() {
        return List.of(new BlockModule(this), new BreedingModule(this), new BrewingModule(this), new DamageSourceModule(this), new EntityModule(this), new FishingModule(this), new InputModule(this), new ItemModule(this), new ItemComponentModule(this), new LootTableModule(this), new MiscModule(this), new ParticleModule(this), new PDCModule(this), new PotionModule(this), new TagModule(this), new TextModule(this));
    }
