...
extends SimpleLiteral<Timespan> {
    ...
    static {
        Skript.registerExpression(LitEternity.class, Timespan.class, ExpressionType.SIMPLE, "[an] eternity", "forever", "[an] (indefinite|infinite) (duration|timespan)");
    }
}
