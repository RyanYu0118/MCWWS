...
@Name(value="Maximum Integer Value")
@Description(value={"A number representing the maximum value of an integer number type."})
@Example(value="if {_number} >= maximum integer value:")
@Since(value={"2.13"})
public class LitIntMaxValue
