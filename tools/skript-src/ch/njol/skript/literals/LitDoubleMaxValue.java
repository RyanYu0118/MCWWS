...
@Name(value="Maximum Double Value")
@Description(value={"A number representing the maximum value of a double number type."})
@Example(value="if {_number} >= maximum double value:")
@Since(value={"2.13"})
public class LitDoubleMaxValue
