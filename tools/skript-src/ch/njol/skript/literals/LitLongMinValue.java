...
@Name(value="Minimum Long Value")
@Description(value={"A number representing the minimum value of a long number type."})
@Example(value="if {_number} <= minimum long value:")
@Since(value={"2.13"})
public class LitLongMinValue
