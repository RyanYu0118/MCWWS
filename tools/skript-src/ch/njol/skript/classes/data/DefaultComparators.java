    ...
    static {
        ...
        Comparators.registerComparator(Block.class, Block.class, new Comparator<Block, Block>(){
            ...
            public Relation compare(Block b1, Block b2) {
                return Relation.get(BlockUtils.extractBlock(b1).equals((Object)BlockUtils.extractBlock(b2)));
            }
        ...
        Comparators.registerComparator(CommandSender.class, CommandSender.class, new Comparator<CommandSender, CommandSender>(){
            ...
            public Relation compare(CommandSender s1, CommandSender s2) {
                return Relation.get(s1.equals((Object)s2));
            }
        ...
        Comparators.registerComparator(EntityDamageEvent.DamageCause.class, ItemType.class, new Comparator<EntityDamageEvent.DamageCause, ItemType>(){
            ...
            @Override
            public Relation compare(EntityDamageEvent.DamageCause dc, ItemType t) {
                switch (dc) {
                    case FIRE: {
        ...
        Comparators.registerComparator(EntityDamageEvent.DamageCause.class, EntityData.class, new Comparator<EntityDamageEvent.DamageCause, EntityData>(){
            ...
            @Override
            public Relation compare(EntityDamageEvent.DamageCause dc, EntityData e) {
                switch (dc) {
                    case ENTITY_ATTACK: {
        ...
        Comparators.registerComparator(EnchantmentType.class, Enchantment.class, (enchantmentType, enchantment) -> Relation.get(enchantmentType.getType().equals(enchantment)));
        ...
        Comparators.registerComparator(Location.class, Location.class, new Comparator<Location, Location>(){
            ...
            public Relation compare(Location first, Location second) {
                return Relation.get(Objects.equals(first.getWorld(), second.getWorld()) && first.toVector().equals((Object)second.toVector()) && Location.normalizeYaw((float)first.getYaw()) == Location.normalizeYaw((float)second.getYaw()) && Location.normalizePitch((float)first.getPitch()) == Location.normalizePitch((float)second.getPitch()));
            }
        ...
        Comparators.registerComparator(Color.class, Color.class, (one, two) -> Relation.get(one.asBukkitColor().equals((Object)two.asBukkitColor())));
        ...
        if (Skript.classExists("org.bukkit.entity.EntitySnapshot")) {
            final boolean SNAPSHOT_AS_STRING_EXISTS = Skript.methodExists(EntitySnapshot.class, "getAsString", new Class[0]);
            Comparators.registerComparator(EntitySnapshot.class, EntitySnapshot.class, new Comparator<EntitySnapshot, EntitySnapshot>(){
                ...
                public Relation compare(EntitySnapshot snap1, EntitySnapshot snap2) {
                    if (!snap1.getEntityType().equals((Object)snap1.getEntityType())) {
                        return Relation.NOT_EQUAL;
                    }
                    boolean isEqual = !SNAPSHOT_AS_STRING_EXISTS ? snap1.equals((Object)snap2) || snap1.hashCode() == snap2.hashCode() : snap1.getAsString().equalsIgnoreCase(snap2.getAsString());
